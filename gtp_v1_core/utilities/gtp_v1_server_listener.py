...
from gtp_v1_core.utilities.path_managment_listener import PathMgmtListener

from gtp_v1_core.commons.gtp_v1_commons import GTP_PORT

class ServerListener(threading.Thread):
    def __init__(self, peer, messages, isVerbose = True, msgs_freq=1, 
                 wait_time=20, port = 2123):
        threading.Thread.__init__(self)
        
        self.TAG_NAME = 'GTPV1 SERVER_LISTENER'
